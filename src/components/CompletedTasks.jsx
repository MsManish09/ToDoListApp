    ...
    return(
        completedTask.map((task, index)=>{
            ...
            return(
                ...
                <div className=" flex border-2 border-solid border-gray-50 p-2 pl-6 pr-6 justify-between items-center gap-4 w-[80%] rounded-[15px] bg-green-200 flex-wrap " key={task.id} >
